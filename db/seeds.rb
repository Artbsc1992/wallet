...
#Operations
op1_1 = Operation.create(name: 'Pizza', amount: 15.50, user_id: user1.id)
op1_2 = Operation.create(name: 'Tuna Sandwich', amount: 3.15, user_id: user1.id)
op1_3 = Operation.create(name: 'Electricity', amount: 190.50, user_id: user1.id)
op1_4 = Operation.create(name: 'Gas', amount: 301.98, user_id: user1.id)
op2_1 = Operation.create(name: 'House A', amount: 250700.00, user_id: user2.id)
op2_2 = Operation.create(name: 'House B', amount: 390500.00, user_id: user2.id)
op2_3 = Operation.create(name: 'John', amount: 312.00, user_id: user2.id)
op2_4 = Operation.create(name: 'Mill', amount: 312.00, user_id: user2.id)
